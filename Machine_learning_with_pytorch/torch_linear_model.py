...
if __name__ == "__main__":
	...
	sample_data = Data_handling()

	sample_data.make_data()

	sample_data_x = sample_data.X[0:10]
	sample_data_y = sample_data.Y[0:10]

	y_pred = model(sample_data_x)


	#make the data predition on the model
	print(y_pred)
	print(sample_data_y)